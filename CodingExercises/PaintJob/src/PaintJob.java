...
buckets of paint he needs to buy before going to work. Bob might also have some extra buckets at home. He also knows
...
public class PaintJob {
    ...
    public static int getBucketCount (double width, double height, double areaPerBucket, int extraBuckets) {
        ...
        if ((width <= 0 || height <= 0 || areaPerBucket <= 0) || extraBuckets < 0) {
            ...
            areaCovered = areaPerBucket * extraBuckets;
            remainingArea = wallArea - areaCovered;
            bucketsToBuy = (int)(Math.ceil(remainingArea / areaPerBucket));
    ...
    public static int getBucketCount (double width, double height, double areaPerBucket) {
        ...
        if (width <= 0 || height <= 0 || areaPerBucket <= 0) {
            ...
            wallArea = width * height;
            bucketsToBuy = (int)(Math.ceil(wallArea / areaPerBucket));
        }
        return bucketsToBuy;
    }
