...
public class Hamburger {
    ...
    public double itemizedHamburger() {
        ...
        if (this.additional1Name != null) {
            ...
            System.out.println("Added "  + this.additional1Name + " for a price of " + this.additional1Price);
        }

        if (this.additional2Name != null) {
            hamburgerPrice += this.additional2Price;
            System.out.println("Added "  + this.additional2Name + " for a price of " + this.additional2Price);
        }

        if (this.additional3Name != null) {
            hamburgerPrice += this.additional3Price;
            System.out.println("Added "  + this.additional3Name + " for a price of " + this.additional3Price);
        }

        if (this.additional4Name != null) {
            hamburgerPrice += this.additional4Price;
            System.out.println("Added "  + this.additional4Name + " for a price of " + this.additional4Price);
        }
