...
public class Datasource {
    ...
    public static final String CONNECTION_STRING = "jdbc:sqlite:/Users/deepanshusarawagi/Desktop/Learning/Java/Databases/MusicBrowser/" + DB_NAME;
    ...
    public List<Album> queryAlbumForArtistId(int id) {
        try {
            ...
            while (results.next()) {
                ...
                album.setArtistID(results.getInt(id));
                albums.add(album);
            }
            return albums;
        } catch (SQLException e) {
